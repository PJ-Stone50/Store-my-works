...
SECRET_KEY = 'i45q1_e2=755$xu$b781r+t^9ep5b28a+y9$0oaw+@gzffbzv!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*'] # ใส่ '*' เพื่อให้ ngrok สามารถรันได้
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'myapp/template')], # ใช้คำสั่ง os.path.join เพื่อให้ direct template
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
