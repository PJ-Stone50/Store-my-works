...
class Snake(Canvas):
	...
	def check_food_collistion(self):
		if self.snake_positions[0] == self.food_positions: # ถ้าหัวมันกินแล้วฟังก์ชันทำงาน
			self.score += 1
...
def newwindow():
	...
	frame_in_root = Frame(root,bg='red')
	frame_in_root.grid(sticky="news",padx=0,pady=0)
